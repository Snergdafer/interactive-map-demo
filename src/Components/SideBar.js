...
const SideBar = ({handleNavigationPress, mapVisible}) => { 
    ...
    return (
            <Flex flexDirection='column' position='fixed' w='350px' bgColor='#949396' h='100vh'>
                <Flex boxShadow='lg' w='100%' h='100px' alignItems='center' justifyContent='center' bgColor='#ABA8B2'>
